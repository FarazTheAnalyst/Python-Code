...
def_args = {"owner":"airflow", "retries":0, "start_date": datetime(2025, 1, 1)}

with DAG("dag_ex_airflow_variables", default_args=def_args, catchup=False) as dag:

    start = DummyOperator(task_id = "START")
    airflow_variables = PythonOperator(task_id = "AIRFLOW_VARIABLES",
